...
//import static org.demoiselle.aliceREST.chatter.bitoflife.chatterbean.text.TransformationsTest.assertRequest;
//import static org.demoiselle.aliceREST.chatter.bitoflife.chatterbean.text.TransformationsTest.assertSentence;
...
/*
  ...
  public void testLearn()
  {
	...
	//String url = "file:///" + mother.getBundle().getString("load.learned");
...
//    String s = "file:///" + mother.getBundle().getString("load.learned");
//    assertEquals("Ok.", bot.respond("Learn this resource: " + s));
